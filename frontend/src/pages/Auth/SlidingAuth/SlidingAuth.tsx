...
const SlidingAuth: FC<Props> = ({ initialMode = "signin" }) => {
  ...
  const containerClass = `${styles["sa-container"]} ${
    rightActive ? styles["sa-rightPanelActive"] : ""
  }`;
  ...
  return (
    <div className={styles["sa-wrapper"]}>
      <div className={styles["sa-mobileToggle"]}>
        <button
          className={`${styles["sa-mobileBtn"]} ${
            !rightActive ? styles["sa-activeMobileBtn"] : ""
          }`}
          onClick={showSignin}
          type="button">
          Sign In
      ...
      <div id="container" className={containerClass}>
        <div
          className={`${styles["sa-formContainer"]} ${styles["sa-signUpContainer"]}`}>
        ...
        <div
          className={`${styles["sa-formContainer"]} ${styles["sa-signInContainer"]}`}>
          <div className={styles["sa-inner"]}>
            <h1>Sign in</h1>
            <div className={styles["sa-social"]}>
        ...
        <div className={styles["sa-overlayContainer"]}>
          <div className={styles["sa-overlay"]}>
            <div
              className={`${styles["sa-overlayPanel"]} ${styles["sa-overlayLeft"]}`}>
              <h1>Welcome Back!</h1>
              <p>
                To keep connected with us please login with your personal info
              </p>
              <button
                className={styles["sa-overlayBtn"]}
                onClick={showSignin}
                type="button">
                Sign In
              </button>
            ...
            <div
              className={`${styles["sa-overlayPanel"]} ${styles["sa-overlayRight"]}`}>
              <h1>Hello, Friend!</h1>
